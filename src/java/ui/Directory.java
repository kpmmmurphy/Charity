...
public class Directory extends HttpServlet {
    ...
    private ResultSetMetaData detailsMetaData;
    private Array names;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.err.println("Problem retreiving current charities hosted");
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Directory</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Current charities that we host</h1>");
            out.println("<ul>");
            while(detailsResultSet.next()) {
                String name = detailsResultSet.getString("name");
